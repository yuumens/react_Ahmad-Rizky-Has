...
const CreateProducts = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    document.querySelector(`input[value="${productFreshness}"]`).checked = true;
    reset(); 
  };
        ...
        <div className="col-md-8">
          ...
          <form className="needs-validation" noValidate onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group mb-3">
              <label htmlFor="productCategory" data-testid='productCategory'>Product Category :</label>
              <Controller
            ...
            <label htmlFor="priceInput">Product Price: </label>
              ...
              <div className=" m-4 d-md-flex justify-content-md-center">
                <button data-testid="submitBtn" type="submit" className="btn btn-primary btn-block d-grid col-6 mx-auto">
                Submit
                </button>
              </div>
          </form>
